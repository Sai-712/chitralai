            ...
            {showQRModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-blue-300 rounded-lg p-6 max-w-sm w-full">
                  ...
                  <div className="flex flex-col items-center space-y-4">                    <p className="text-sm text-blue-700 mb-2">Share this QR code or link with others to let them find their photos</p>
                    <div className="qr-modal relative">
                      <QRCodeSVG
